...
layer2_height = int(input("Enter height of layer 2 (cm): "))  
layer2_diameter = int(input("Enter diameter of layer 2 (cm): "))

layer3_height = int(input("Enter height of layer 3 (cm): "))
layer3_diameter = int(input("Enter diameter of layer 3 (cm): "))
